...
export async function generateMetadata({ params: { lng } }: INextPageParams): Promise<Metadata> {
  if (lng === 'en') {
    return {
      ...
      ...getEnMetadata({
        url: `${config.urls.site}/en`,
        title: "Weestep Kids - Taking care of children's feet!",
        description: '👟💖 Dive into the world of comfort with our children\'s shoes! 💫 300+ models of orthopedic footwear - caring for your child\'s health. Find the perfect pair right now and get a -50% discount! 👣🌟. Our footwear is perforated, anti-shock, ergonomic, removable, leather, comfortable, anatomical, breathable and orthopedic.',
      }),
    };
  }
  ...
  return {
    ...
    ...getEsMetadata({
      ...
      description: '👟💖 ¡Sumérgete en el mundo de la comodidad con nuestros zapatos para niños! 💫 Más de 300+ modelos de calzado ortopédico: cuidado de la salud de tu hijo. ¡Encuentra el par perfecto ahora y obtén un descuento del -50%! 👣🌟. Nuestro calzado es perforado, antichoque, ergonómico, extraíble, de piel, cómodo, anatómico, transpirable y ortopédico.',
    }),
  };
}
